...
import DispatchList from './components/DispatchesData';
    ...
    return (
        <div className='d-flex w-100 overflow-hidden'>
            ...
            <div className='main-content'>
                ...
                <DispatchList key={refreshKey} searchQuery={searchQuery} /> {/* Pass searchQuery as prop */}
